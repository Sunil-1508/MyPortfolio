        ...
        <div className="row">
            ...
            <div className="col-md-4">
                <div className="box">
                    ...
                    <ul>
                        <li>AWS <div className="progress" role="progressbar" aria-label="Example with label" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><div className="progress-bar" style={{width:"70%"}} >70%</div></div>
                        </li>
